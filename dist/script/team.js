...
const twitterSvg = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const linkedinSvg = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const webSvg = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function renderTeam(team) {
    ...
    team.forEach((member) => {
        ...
        socialDiv.classList.add("team-social");
        socialDiv.innerHTML = `
        <a href="" class="team-icon">${twitterSvg}</a>
        <a href="" class="team-icon">${linkedinSvg}</a>
        <a href="" class="team-icon">${webSvg}</a>`;
