...
function updateFilterTitle() {
    ...
    if (activeFilter === "all") {
        ...
        titleElement.textContent =
            "".concat(activeFilter.charAt(0).toUpperCase() + activeFilter.slice(1), " products");
    }
}
/*
...
function filterAndRenderProducts() {
    updateFilterTitle();
    filteredProducts = allProducts1.filter(function (product) {
...
function displayCurrentPage() {
    ...
    var productsToShow = filteredProducts.slice(0, endIndex);
    renderProductCards(productsToShow);
    // Esconder botão no fim
    if (endIndex >= filteredProducts.length) {
        loadMoreBtn === null || loadMoreBtn === void 0 ? void 0 : loadMoreBtn.classList.add("hidden");
    }
    else {
        loadMoreBtn === null || loadMoreBtn === void 0 ? void 0 : loadMoreBtn.classList.remove("hidden");
    }
}
...
function addToCart(product, quantity) {
    ...
    var currentQuantityInCart = existingItem ? existingItem.quantity : 0;
    ...
    updateCartCount();
    var unitLabel = quantity > 1 ? 'units' : 'unit';
    showConfirmationMessage("".concat(quantity, " ").concat(unitLabel, " of ").concat(product.name, " added to your cart!"));
}
